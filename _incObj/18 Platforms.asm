...
loc_5922:
		...
		move.l	#Map_Plat_GHZ,objMap(a0)
		move.b	#$20,objActWid(a0)
		cmpi.b	#id_SZ,(v_zone).w
		bne.s	loc_5950
		move.l	#Map_Plat_SZ,objMap(a0)
		move.b	#$20,objActWid(a0)

loc_5950:
		cmpi.b	#id_SLZ,(v_zone).w
		bne.s	loc_5972
		move.l	#Map_Plat_SLZ,objMap(a0)
		move.b	#$20,objActWid(a0)
...
loc_5972:
		...
		move.w	objY(a0),$2C(a0)
		move.w	objY(a0),$34(a0)
		move.w	objX(a0),$32(a0)
		move.w	#$80,objAngle(a0)
		moveq	#0,d1
...
loc_5BA8:
		move.b	(v_oscillate+$1A).w,objAngle(a0)
		rts
; ---------------------------------------------------------------------------
