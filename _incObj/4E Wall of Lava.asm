...
loc_CC16:
		move.b	#id_LavaWall,objId(a1)
		move.l	#Map_LWall,objMap(a1)
		move.w	#$63A8,objGfx(a1)
		move.b	#4,objRender(a1)
		move.b	#$50,objActWid(a1)
		move.w	objX(a0),objX(a1)
		move.w	objY(a0),objY(a1)
		move.b	#1,objPriority(a1)
		move.b	#0,objAnim(a1)
		move.b	#$94,objColType(a1)
		move.l	a0,$3C(a1)

loc_CC58:
		dbf	d1,loc_CC10
		addq.b	#6,objRoutine(a1)
		move.b	#4,objFrame(a1)
