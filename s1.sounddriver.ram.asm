...
v_detune_start:
v_detune_freq1:		ds.w	1	; store slot 1 detune frequency (2 bytes)
v_detune_freq2:		ds.w	1	; store slot 2 detune frequency (2 bytes)
v_detune_freq3:		ds.w	1	; store slot 3 detune frequency (2 bytes)
v_detune_freq4:		ds.w	1	; store slot 4 detune frequency (2 bytes)
v_detune_end:
