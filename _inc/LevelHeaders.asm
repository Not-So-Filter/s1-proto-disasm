...
;				level gfx*			16x16 data			music*
	...
	lhead	plcid_SZ,	Nem_SZ,	        plcid_SZ2,	Blk16_SZ,	Blk256_SZ,	bgm_SZ,	        palid_SZ ; Sparkling
	lhead	plcid_CWZ,	Nem_CWZ,	plcid_CWZ2,	Blk16_CWZ,	Blk256_CWZ,	bgm_CWZ,	palid_CWZ ; Clock Work
	even
